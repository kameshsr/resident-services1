-- Local development init script for the Resident Services database.
-- Generated from db_scripts/mosip_resident (db.sql + ddl/*.sql) with
-- psql meta-commands (\c, \ir) and variables resolved for docker-entrypoint use.
...
-- ===== ddl/resident_grievance_ticket.sql =====
-- -------------------------------------------------------------------------------------------------
