...
COMMENT ON COLUMN resident_session.ip_address IS 'The encrypted ip_address of device from which the user logged in (MOSIP-41105)';
COMMENT ON COLUMN resident_session.host IS 'The encrypted host of device from which the user logged in (MOSIP-41105)';
